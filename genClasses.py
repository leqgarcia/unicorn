...
class Genesis:
    ...
    def printFeatureDict(self, features_dict):
        ...
        for x in range(len(features_dict['barcodes'])):
            ...
            print features_dict['barcodes'][x].barcode + "\n Rot: " + str(features_dict['barcodes'][x].rotation) + " Constant: ",
            print str(features_dict['barcodes'][x].constant) + " Width: " + str(features_dict['barcodes'][x].width) + " Height: ",
            print str(features_dict['barcodes'][x].height) + "\n FullAscii: " + str(features_dict['barcodes'][x].full_ascii) + " Cksum: ",
            print str(features_dict['barcodes'][x].cksum) + " Invert BG: " + str(features_dict['barcodes'][x].invert_bg) + "\n addTxt: ",
            print str(features_dict['barcodes'][x].add_text) + " TextLoc: " + features_dict['barcodes'][x].text_loc + " Text: ",
...
class Matrix(Genesis,MatrixCmds):
    ...
    def getRow(self, name):
        ...
        means the layer doesn't exist name - string containing name of layer"""
        self.getInfo()
